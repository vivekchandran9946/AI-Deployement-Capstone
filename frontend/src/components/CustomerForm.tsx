...
export const CustomerForm: React.FC<CustomerFormProps> = ({
  ...
  return (
    <form onSubmit={onSubmit} className="space-y-8 animate-fade-in w-full">
      ...
      {/* Quick Presets Bar */}
      <div className="p-[1.5px] rounded-3xl bg-gradient-to-r from-blue-600 via-indigo-600 to-sky-600 shadow-md">
        <div className="bg-white backdrop-blur-xl p-4 sm:p-5 rounded-[23px] flex flex-wrap items-center justify-between gap-3 border border-slate-200">
          <div className="flex items-center gap-2.5">
            <div className="p-2 rounded-2xl bg-gradient-to-r from-blue-600 to-indigo-600 text-white shadow-md glow-blue">
          ...
          <div className="flex flex-wrap gap-2">
            {PRESETS.map((p) => (
              <button
                ...
                className="px-3.5 py-1.5 text-xs font-black rounded-xl bg-slate-100 text-slate-800 border border-slate-300 shadow-xs hover:bg-blue-50 hover:border-blue-400 hover:text-blue-700 transition-all cursor-pointer"
              >
                {p.name}
              </button>
            ))}
            <button
              type="button"
              onClick={onReset}
              className="px-3.5 py-1.5 text-xs font-black rounded-xl bg-slate-200 text-slate-800 border border-slate-300 hover:bg-slate-300 transition-all flex items-center gap-1 cursor-pointer"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8 w-full">
        ...
        {/* CARD 1: DEMOGRAPHICS */}
        <div className="p-[1.5px] rounded-3xl bg-gradient-to-b from-blue-400/30 to-indigo-300/20 shadow-md">
          <div className="app-card rounded-[23px] p-6 sm:p-7 space-y-5 h-full transition-all duration-300 bg-white border border-slate-200">
            <div className="flex items-center space-x-3 pb-3 border-b border-slate-200">
              <div className="p-3 rounded-2xl bg-blue-50 text-blue-600 border border-blue-200 glow-blue">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-bold">Personal & family attributes</p>
              </div>
            </div>
                ...
                {['Male', 'Female'].map((g) => (
                  <button
                    ...
                    className={`py-2.5 px-3 text-xs font-black rounded-xl border transition-all cursor-pointer ${
                      formData.gender === g
                        ? 'bg-gradient-to-r from-blue-600 to-indigo-600 text-white border-blue-600 shadow-md glow-blue'
        ...
        <div className="p-[1.5px] rounded-3xl bg-gradient-to-b from-sky-400/30 to-blue-300/20 shadow-md">
          <div className="app-card rounded-[23px] p-6 sm:p-7 space-y-4 h-full transition-all duration-300 bg-white border border-slate-200">
            <div className="flex items-center space-x-3 pb-3 border-b border-slate-200">
              <div className="p-3 rounded-2xl bg-sky-50 text-sky-600 border border-sky-200 glow-cyan">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-bold">Internet, voice & add-ons</p>
              </div>
            </div>
            ...
            <div className="grid grid-cols-1 gap-3.5 max-h-[420px] overflow-y-auto pr-1">
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 text-xs font-black rounded-xl bg-slate-50 border border-slate-300 text-slate-900 focus:ring-2 focus:ring-blue-500 shadow-xs"
                >
              ...
              <div>
                ...
                <select
                  ...
                  className="w-full px-3.5 py-2.5 text-xs font-black rounded-xl bg-slate-50 border border-slate-300 text-slate-900 focus:ring-2 focus:ring-blue-500 shadow-xs disabled:opacity-50"
                >
                  <option value="No">No</option>
                  <option value="Yes">Yes</option>
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block text-[11px] font-black text-slate-700 mb-1 flex items-center gap-1">
                    <Lock className="w-3 h-3 text-blue-600" /> Security
                  </label>
                  <select
                    value={formData.OnlineSecurity}
                    disabled={formData.InternetService === 'No'}
                    onChange={(e) => handleFieldChange('OnlineSecurity', e.target.value)}
                    className="w-full px-2.5 py-2 text-xs font-black rounded-xl bg-slate-50 border border-slate-300 text-slate-900 focus:ring-2 focus:ring-blue-500 shadow-xs disabled:opacity-50"
                  >
                    <option value="Yes">Yes</option>
                    <option value="No">No</option>
                ...
                <div>
                  <label className="block text-[11px] font-black text-slate-700 mb-1 flex items-center gap-1">
                    <HardDrive className="w-3 h-3 text-indigo-600" /> Backup
                  </label>
                  <select
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block text-[11px] font-black text-slate-700 mb-1 flex items-center gap-1">
                    <Shield className="w-3 h-3 text-emerald-600" /> Protection
                  </label>
                  <select
                ...
                <div>
                  <label className="block text-[11px] font-black text-slate-700 mb-1 flex items-center gap-1">
                    <Headphones className="w-3 h-3 text-teal-600" /> Tech Support
                  </label>
                  <select
              ...
              <div className="grid grid-cols-2 gap-2">
                <div>
                  <label className="block text-[11px] font-black text-slate-700 mb-1 flex items-center gap-1">
                    <Tv className="w-3 h-3 text-purple-600" /> TV Stream
                  </label>
                  <select
                ...
                <div>
                  <label className="block text-[11px] font-black text-slate-700 mb-1 flex items-center gap-1">
                    <Film className="w-3 h-3 text-rose-600" /> Movies
                  </label>
                  <select
        ...
        <div className="p-[1.5px] rounded-3xl bg-gradient-to-b from-indigo-400/30 to-blue-300/20 shadow-md">
          <div className="app-card rounded-[23px] p-6 sm:p-7 space-y-5 h-full transition-all duration-300 bg-white border border-slate-200">
            <div className="flex items-center space-x-3 pb-3 border-b border-slate-200">
              <div className="p-3 rounded-2xl bg-indigo-50 text-indigo-600 border border-indigo-200 glow-blue">
              ...
              <div>
                ...
                <p className="text-xs text-slate-500 font-bold">Tenure, payment & charges</p>
              </div>
            </div>
            ...
            <div>
              <div className="flex justify-between items-center mb-1.5">
                <label className="text-xs font-black text-slate-700 flex items-center gap-1 uppercase tracking-wider">
                  <Calendar className="w-3.5 h-3.5 text-blue-600" /> Tenure (Months)
                </label>
            ...
            <div className="grid grid-cols-2 gap-3 pt-2">
              <div>
                ...
                <div className="relative">
                  <span className="absolute inset-y-0 left-0 pl-2.5 flex items-center text-slate-500 text-xs font-black">
                    $
                  </span>
                  <input
                    type="number"
                    ...
                    className="w-full pl-6 pr-2 py-2.5 text-xs font-black rounded-xl bg-slate-50 border border-slate-300 text-slate-900 focus:ring-2 focus:ring-blue-500 shadow-xs"
                  />
                </div>
              </div>
              ...
              <div>
                <div className="flex justify-between items-center mb-1">
                  ...
                  <button
                    ...
                    className="text-[10px] text-blue-600 hover:underline font-black uppercase"
                  >
                    Auto
                  </button>
                </div>
      ...
      {/* Large Glowing CTA Submit Button */}
      <div className="flex justify-center pt-4">
        <button
          type="submit"
          disabled={isLoading}
          className="w-full sm:w-auto px-16 py-5 rounded-2xl bg-gradient-to-r from-blue-600 via-indigo-600 to-blue-700 hover:from-blue-700 hover:to-indigo-700 text-white font-black text-base uppercase tracking-wider shadow-xl glow-blue hover:scale-[1.02] active:scale-[0.98] transition-all flex items-center justify-center gap-3 cursor-pointer border border-blue-500/30 disabled:opacity-60"
        >
          {isLoading ? (
            <>
            ...
            <>
              <Sparkles className="w-5 h-5 text-blue-200 animate-bounce" />
