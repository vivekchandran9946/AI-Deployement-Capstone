...
export const ResultDashboard: React.FC<ResultDashboardProps> = ({
  ...
  return (
    <div id="results-section" className="space-y-8 animate-fade-in scroll-mt-24">
      ...
      {/* ---------------------------------------------------- */}
      <div
        className={`rounded-3xl p-7 sm:p-9 border-2 shadow-xl transition-all duration-500 ${
          isStay
            ? 'bg-gradient-to-r from-emerald-600 via-teal-600 to-slate-900 border-emerald-400/50 text-white shadow-emerald-500/20'
            : 'bg-gradient-to-r from-rose-600 via-red-600 to-slate-900 border-rose-400/50 text-white shadow-rose-500/20'
        }`}
      >
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        <div className="app-card rounded-3xl p-6 shadow-sm space-y-3 bg-white border border-slate-200">
          <div className="flex items-center justify-between text-slate-700 text-xs font-black uppercase tracking-wider">
        ...
        {/* KPI 3: Risk Level */}
        <div className={`rounded-3xl p-6 border ${riskInfo.borderColor} ${riskInfo.bgColor} shadow-sm space-y-3`}>
      ...
      {/* ---------------------------------------------------- */}
      <div className="bg-gradient-to-r from-blue-50 via-white to-indigo-50 text-slate-900 rounded-3xl p-7 sm:p-8 border border-blue-200 shadow-md space-y-4 glow-blue">
        <div className="flex items-center space-x-3">
          <div className="p-3 rounded-2xl bg-blue-100 text-blue-700 border border-blue-300">
            <Lightbulb className="w-6 h-6 text-blue-600 animate-pulse" />
          </div>
          <div>
            <h3 className="text-lg font-black text-slate-900">ConnectTel AI Strategic Recommendation</h3>
            <p className="text-xs text-slate-600 font-semibold">Automated retention action plan</p>
          </div>
        </div>
      ...
      <div className="app-card rounded-3xl p-6 sm:p-8 shadow-sm space-y-6 bg-white border border-slate-200">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 pb-4 border-b border-slate-200">
          ...
          <span className="text-xs font-black px-3.5 py-1.5 rounded-full bg-slate-100 text-slate-800 border border-slate-300">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-left text-xs">
            <thead>
              <tr className="border-b border-slate-300 text-slate-800 uppercase font-black text-[10px] tracking-wider bg-slate-100">
            ...
            <tbody className="divide-y divide-slate-200 font-bold text-slate-800">
              ...
              {/* Demographics */}
              <tr>
                <td className="py-2.5 px-4 font-black text-blue-700" rowSpan={4}>
                  Demographics
                </td>
              ...
              <tr className="bg-slate-50/80">
                <td className="py-2.5 px-4 font-black text-indigo-700" rowSpan={9}>
                  Subscribed Services
                </td>
              ...
              <tr className="bg-slate-50/80">
                ...
                <td className="py-2.5 px-4 font-black text-slate-900">{customerData.InternetService}</td>
              </tr>
              <tr className="bg-slate-50/80">
              ...
              {/* Account & Billing */}
              <tr>
                <td className="py-2.5 px-4 font-black text-emerald-700" rowSpan={6}>
                  Billing & Financials
                </td>
              ...
              <tr>
                ...
                <td className="py-2.5 px-4 font-black text-blue-700">{customerData.Contract}</td>
              </tr>
              <tr>
